...
export default function Banner() {
  return (
    <div className="w-full h-[600px] bg-center bg-no-repeat bg-cover bg-banner relative">
      <div className="absolute w-full h-full top-0 left-0 bg-black opacity-50" />
      <div className="w-full h-full flex items-center justify-center space-x-[30px] p-4 relative z-20">
        <div className="flex flex-col space-y-5 items-baseline w-[50%] ml-5">
          <p className="text-white bg-gradient-to-r from-red-600 to-red-300 py-2 px-3 text-md ">
            TV Show
          </p>
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-white">
              ...
              doloremque eius iure velit molestiae, iusto ea temporibus
              accusamus, veniam illo pariatur molestias? Autem eveniet
              praesentium dolorum aliquid, facilis voluptatibus?
            </p>
